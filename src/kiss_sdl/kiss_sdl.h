...
extern kiss_image kiss_normal, kiss_prelight, kiss_active, kiss_bar, kiss_up,
    kiss_down, kiss_left, kiss_right, kiss_vslider, kiss_hslider, kiss_selected,
...
int kiss_renderimage(SDL_Renderer *renderer, kiss_image image, int x, int y,
                     SDL_Rect *clip);
